...
import { GenerateGeneralJobOfferDocument, generateGeneralJobOfferPreviewContent } from '../OfferLetterWordDocConstants';
...
const JobOfferTemplatePage = () => {
  ...
  const handleDownload = async () => {
    try {
      const doc = GenerateGeneralJobOfferDocument({
      ...
      saveAs(blob, 'general_job_offer_template.docx');
    } catch (error) {
          ...
          <ShPaper variant='outlined'>
            <Grow in={true} timeout={1000} mountOnEnter unmountOnExit>
              <Stack padding={isSmScreen ? 2 : 5}>
                ...
                <Typography textAlign='center' variant={isSmScreen ? 'body2' : 'body1'} color='text.secondary'>
