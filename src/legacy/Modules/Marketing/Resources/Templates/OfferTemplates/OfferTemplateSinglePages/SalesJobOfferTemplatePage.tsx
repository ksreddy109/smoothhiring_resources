...
import { GenerateSalesJobOfferDocument, generateSalesJobOfferPreviewContent } from '../OfferLetterWordDocConstants';
import { ResourceCTA } from '../../../ResourceCTA';

const SalesJobOfferTemplatePage = () => {
  ...
  const handleDownload = async () => {
    try {
      const doc = GenerateSalesJobOfferDocument({
      ...
      saveAs(blob, 'sales_job_offer_template.docx');
    } catch (error) {}
  };
          ...
          <Stack padding={isSmScreen ? 0 : 3} paddingBottom={10} spacing={2} maxWidth='950px' margin='auto'>
            <ShPaper variant='outlined'>
              ...
              <Stack padding={2} direction={'column'} spacing={3}>
                {generateSalesJobOfferPreviewContent({
                  companyName: companyName,
                  candidateName: candidateName,
                  jobTitle: jobTitle,
                  employmentType: employmentType,
...
export default SalesJobOfferTemplatePage;
