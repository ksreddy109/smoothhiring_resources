...
export const EmployerInterivewTemplatePreviewFields: React.FC<JobInterviewFormProps> = ({ isSmScreen, companyName, candidateName, jobTitle, department, yourName, signature, setCompanyName, setCandidateName, setJobTitle, setDepartment, setYourName, setSignature }) => {
