...
import { GenerateInternalJobOfferDocument, generateInternalJobOfferPreviewContent } from '../OfferLetterWordDocConstants';
import { ResourceCTA } from '../../../ResourceCTA';

const InternalJobOfferTemplatePage = () => {
  ...
  const handleDownload = async () => {
    try {
      const doc = GenerateInternalJobOfferDocument({
      ...
      saveAs(blob, 'internal_job_offer_template.docx');
    } catch (error) {}
  };
...
export default InternalJobOfferTemplatePage;
